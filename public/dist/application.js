...
(function () {
    ...
    // Use Application configuration module to register a new module
    ApplicationConfiguration.registerModule('esrimaps');
})();
...
(function () {
    'use strict';
    angular.module('core').controller('MainCtrl', ["$scope", "$timeout", "QueueService", function ($scope, $timeout, QueueService) {
...
angular.module('core').factory('QueueService', ["$rootScope", function ($rootScope) {
...
angular.module('core').animation('.slide-animation', ["$window", function ($window) {
    return {
...
angular.module('core').directive('bgImage', ["$window", function ($window) {
        ...
        var shouldRender = function(user) {
            if (user) {
                if (!!~this.roles.indexOf('*')) {
                    ...
                    // Now, User has single Role is string
...
(function () {
    ...
    angular.module('users').config(['$httpProvider',
        ...
        function (Menus) {
            ...
            Menus.addMenuItem('topbar', 'Users', 'Users', 'dropdown', '', false, [ 'admin']);
